...
const SaudiPage: React.FC = () => {
  const { t, language } = useLanguage();

  const routes = [
    { from: language === 'ar' ? 'أبوظبي' : 'Abu Dhabi', to: language === 'ar' ? 'الرياض' : 'Riyadh' },
    { from: language === 'ar' ? 'دبي' : 'Dubai', to: language === 'ar' ? 'جدة' : 'Jeddah' },
    { from: language === 'ar' ? 'الشارقة' : 'Sharjah', to: language === 'ar' ? 'الدمام' : 'Dammam' },
    { from: language === 'ar' ? 'أبوظبي' : 'Abu Dhabi', to: language === 'ar' ? 'مكة' : 'Mecca' },
    { from: language === 'ar' ? 'دبي' : 'Dubai', to: language === 'ar' ? 'المدينة المنورة' : 'Medina' },
  ];
  ...
  const features = [
    ...
    { icon: Clock, title: language === 'ar' ? 'توصيل سريع' : 'Fast Delivery', desc: language === 'ar' ? 'خلال 3-5 أيام عمل' : 'Within 3-5 business days' },
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              {getTranslation(t, 'saudi.pageTitle')}
            </h1>
            <p className="text-xl text-gray-300 leading-relaxed mb-8">
              {getTranslation(t, 'saudi.pageSubtitle')}
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-xl text-gray-600 leading-relaxed text-center mb-16">
              {getTranslation(t, 'saudi.pageDescription')}
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              {getTranslation(t, 'saudi.routesTitle')}
            </h2>
      ...
      <section className="py-20 bg-gradient-to-r from-[#e63946] to-[#d32f2f]">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            {getTranslation(t, 'saudi.ctaTitle')}
          </h2>
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            {language === 'ar'
              ? 'احصل على عرض سعر مجاني للشحن من الإمارات إلى السعودية'
              : 'Get a free quote for shipping from UAE to Saudi Arabia'}
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={handleCall}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
              {getTranslation(t, 'saudi.faqTitle')}
            </h2>
            <div className="space-y-4">
              {[
                { q: language === 'ar' ? 'كم يستغرق الشحن من الإمارات للسعودية؟' : 'How long does shipping from UAE to Saudi take?', a: language === 'ar' ? '3-5 أيام عمل عادة' : 'Usually 3-5 business days' },
                ...
                { q: language === 'ar' ? 'ما هي الوثائق المطلوبة؟' : 'What documents are required?', a: language === 'ar' ? 'وثائق تسجيل السيارة وجواز السفر' : 'Vehicle registration and passport' },
